...
ReaderTaskEither<LoggerEnv, Error, string> => pipe(
    RTE.ask<LoggerEnv, Error>(),
    loggingRTE(() => L.debug("Beginning execution of \"createEntity\"")),
 ...
 * The id of the Entity.
 */
export const deleteEntity = (entity: EntityParameters<any>):
ReaderTaskEither<LoggerEnv, Error, any> => pipe(
    updateEntity({
      ...entity,
      parameters: {
        ...entity.parameters,
 ...
 * The id of the Entity.
 */
export const updateEntity = (entityParameters: EntityParameters<any>):
 ReaderTaskEither<LoggerEnv, Error, any> => pipe(
    RTE.ask<LoggerEnv, Error>(),
    loggingRTE(() => L.debug("Beginning execution of \"updateEntity\"")),
    chainReaderTaskEitherTryCatch(
        () => {
 ...
 * The id of the Entity.
 */
export const checkEntity = (type: EntityType, id: string):
 ReaderTaskEither<LoggerEnv, Error, EntityResponseType> => pipe(
    RTE.ask<LoggerEnv, Error>(),
    loggingRTE(() => L.debug("Beginning execution of \"checkEntity\"")),
    chainReaderTaskEitherTryCatch(
        () => {
          switch (type) {
            case "page":
 ...
 * The id of the Entity.
 */
export const checkPage = (id: string):
